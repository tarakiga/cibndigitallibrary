...
export function ShoppingCart({ isOpen, onClose }: ShoppingCartProps) {
  ...
  const getVat = () => Math.round(getSubtotal() * 0.075)
  const getSubtotalWithVat = () => getSubtotal() + getVat()
  
  const getPaystackFee = () => {
    const amount = getSubtotalWithVat()
  ...
  const getFinalTotal = () => getSubtotalWithVat() + getPaystackFee()
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm text-gray-500">
                    ...
                    <span>₦{getPaystackFee().toLocaleString()}</span>
                  </div>
                  <Separator className="my-2" />
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">Total</span>
                    <span className="text-xl font-bold text-[#059669]">₦{getFinalTotal().toLocaleString()}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                Pay ₦{getFinalTotal().toLocaleString()} with Paystack
              </Button>
              <Button 
                variant="outline" 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="flex flex-col">
                      <span>Processing Fee</span>
                      <span className="text-xs text-gray-400">1.5% + ₦100 (capped at ₦2,000)</span>
                    </span>
                    <span>₦{getPaystackFee().toLocaleString()}</span>
                  </div>
                  <Separator />
