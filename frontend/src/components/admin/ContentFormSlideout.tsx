...
export function ContentFormSlideout({
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 3:
        // Price must be 0 (free) or >= 200 (Paystack minimum) when not exclusive
        if (formData.is_exclusive) return true
        return formData.price === 0 || formData.price >= 200
      case 4:
        return true
      default:
        return false
                  ...
                  {currentStep === 3 && (
                    ...
                    />
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              Set to 0 for free content. Paid content must be ₦200 or more (Paystack minimum).
                            </p>
                          </div>
                        )}
