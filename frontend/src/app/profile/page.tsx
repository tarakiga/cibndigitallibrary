...
export default function ProfilePage() {
  ...
  const isCibnMember = user.role === 'cibn_member'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 pt-28 pb-12">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TabsList className={`w-full md:w-auto inline-grid ${isCibnMember ? 'grid-cols-1' : 'grid-cols-2'}`}>
            <TabsTrigger value="profile">Profile Settings</TabsTrigger>
            {!isCibnMember && <TabsTrigger value="security">Security</TabsTrigger>}
          </TabsList>
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    {isCibnMember && (
                      <div className="flex items-center gap-2 text-gray-500 italic mt-2">
                        ...
                        <span>Your profile information cannot be edited here.</span>
                      </div>
                    )}
                  </div>
                  {!isCibnMember && (
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    {isCibnMember ? (
                      (Number(user.arrears || 0) === 0 && Number(user.annual_subscription || 0) === 0) ? (
                        <Badge className="bg-[#059669] hover:bg-[#059669]">Active</Badge>
                      ) : (
