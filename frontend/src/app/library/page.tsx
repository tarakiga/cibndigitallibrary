...
export default function LibraryPage() {
  ...
  const fetchContent = async () => {
    setLoading(true)
    try {
      // Use public endpoint for non-authenticated users, authenticated endpoint otherwise
      const fetcher = isAuthenticated ? contentService.getContent : contentService.getPublicContent
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  <Tabs value={selectedType} onValueChange={setSelectedType} className="w-full">
                    <TabsList className="grid w-full grid-cols-2 h-auto p-1 gap-1.5 bg-gray-100 border border-gray-200 rounded-lg">
                      <TabsTrigger value="all" className="text-xs py-2 border border-gray-300 data-[state=active]:border-[#059669] data-[state=active]:bg-[#059669] data-[state=active]:text-white data-[state=active]:shadow-sm rounded-md">All</TabsTrigger>
                      <TabsTrigger value="document" className="text-xs py-2 border border-gray-300 data-[state=active]:border-[#059669] data-[state=active]:bg-[#059669] data-[state=active]:text-white data-[state=active]:shadow-sm rounded-md">Documents</TabsTrigger>
                      <TabsTrigger value="video" className="text-xs py-2 border border-gray-300 data-[state=active]:border-[#059669] data-[state=active]:bg-[#059669] data-[state=active]:text-white data-[state=active]:shadow-sm rounded-md">Videos</TabsTrigger>
                      <TabsTrigger value="audio" className="text-xs py-2 border border-gray-300 data-[state=active]:border-[#059669] data-[state=active]:bg-[#059669] data-[state=active]:text-white data-[state=active]:shadow-sm rounded-md">Audio</TabsTrigger>
                    </TabsList>
                  </Tabs>
                </div>
