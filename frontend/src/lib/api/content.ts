...
export const contentService = {
  ...
  /**
   * Directly add free or exclusive content to user's library
   */
  async addToLibrary(contentId: number): Promise<{ message: string }> {
    const response = await apiClient.post<{ message: string }>(`/content/me/library/${contentId}`)
