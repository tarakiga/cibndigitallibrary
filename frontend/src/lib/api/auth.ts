...
export const authService = {
   ...
   * Sends POST to /auth/refresh — the interceptor attaches the current JWT via Authorization header.
  ...
  async refreshToken(): Promise<string | null> {
    try {
      ...
      const response = await apiClient.post<{ access_token: string; token_type: string; user: User }>('/auth/refresh')
